	...
	void render(const hittable& world){
		...
		for (int j = 0; j < image_height; ++j)
		{
			for (int i = 0; i < image_width; ++i)
			{
				...
				write_color(f1,pixel_color,samples_per_pixel);
			}
		}
		f1.close();
	...
	void render_withCV(hittable_list& world){
		...
		for (int j = 0; j < image_height; ++j)
		{
			for (int i = 0; i < image_width; ++i)
			{
				...
				write_opencv_color(img0,pixel_color,i,j,samples_per_pixel);
			}
		}
		imshow("test",img0);
		double x=0.0;
			...
			else if (a=='a')
			{
				...
				for (int j = 0; j < image_height; ++j)
				{
					for (int i = 0; i < image_width; ++i)
					{
						...
						write_opencv_color(img1,pixel_color,i,j,samples_per_pixel);
					}
				}
			}else if (a=='d')
			{
